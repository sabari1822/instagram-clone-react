...
function Sidebar() {
  ...
  <div className='m-3 position-fixed'>
   ...
   <div className=' d-flex flex-column gap-3'>
      <img className='logo-text' src='src\assets\Instagram_text.svg.png'></img>
      <div className="sidebar-item"><i className="bi bi-house-door"></i>Home</div>
      ...
      <div className="sidebar-item"><i className="bi bi-play"></i>Reels</div>
      <div className="sidebar-item"><i className="bi bi-chat-dots"></i>Messages</div>
